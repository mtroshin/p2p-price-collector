...
class LocalbitcoinsPriceCollectorS(Collector):
    def __init__(self, browser) -> None:
        self.__browser = browser

    def collect(self) -> t.Iterable[Order]:
        self.__browser.get("https://localbitcoins.com/ru/sell-bitcoins-online/rub/")
        ...
        while(current_page <= total):
            self.__browser.get("https://localbitcoins.com/ru/sell-bitcoins-online/rub/?page=" + str(current_page))
            ...
            banks = []
            while i < len(names):
                banks.append((self.__browser.find_element(By.XPATH, '/html/body/div[6]/table/tbody/tr[' + str(i + 2) + ']/td[2]')))
                i += 1
            i = 0
